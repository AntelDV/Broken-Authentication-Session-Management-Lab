...
def run_rate_limit_test():
    print("BẮT ĐẦU TEST HIỆU QUẢ RATE LIMIT")
    print("Dữ liệu này dùng để vẽ biểu đồ đường Line Chart cho báo cáo:")
    print("=" * 45)
    print(" Giây thứ | Cho phép lọt  | Bị chặn lại  ")
    print("-" * 45)
    ...
    for second in range(1, 11):
        ...
        # Trong 1 giây,  cố tình gửi dồn dập 15 requests
        for _ in range(15): 
